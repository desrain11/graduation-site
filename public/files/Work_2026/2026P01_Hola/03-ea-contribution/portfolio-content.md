...
The FMP builds on the design research from M2.1, shifting the focus from early personalization exploration to AI memory control in self-disclosure contexts. Inspired by the Ebbinghaus forgetting curve [1] and its application in AI memory research (MemoryBank) [2], the project designed and implemented a five-level memory-strength mechanism that allowed users to regulate how strongly Hola recalled prior conversations without directly managing stored content (T&R, MD&C). A seven-day within-subjects field study compared fixed and adjustable memory-strength conditions through questionnaires and semi-structured interviews, based on 21 valid participant pairs (U&S, MD&C). The study found that memory-strength control did not directly lead to higher anticipated communication quality (ACQ) or willingness to disclose, but revealed that users' preferences reflected how they positioned their relationship with Hola, and that recall manner and memory boundaries shaped whether the experience felt supportive or unsettling.
...
- **B&E**: commercial alignment of the research
